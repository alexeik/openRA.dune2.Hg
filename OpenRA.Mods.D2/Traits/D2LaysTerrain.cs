...
{
	public class D2LaysTerrainInfo : ITraitInfo, Requires<BuildingInfo>
	{
		...
		public object Create(ActorInitializer init) { return new D2LaysTerrain(init.Self, this); }
	}

	public class D2LaysTerrain : INotifyAddedToWorld
	{
		readonly D2LaysTerrainInfo info;
		readonly D2BuildableTerrainLayer layer;
