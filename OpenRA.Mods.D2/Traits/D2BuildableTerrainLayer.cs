...
namespace OpenRA.Mods.D2.Traits
{
	...
	public class D2BuildableTerrainLayerInfo : ITraitInfo
	{
		...
		public object Create(ActorInitializer init) { return new D2BuildableTerrainLayer(init.Self, this); }
	}
	...
	public class D2BuildableTerrainLayer : IRenderOverlay, IWorldLoaded, ITickRender, INotifyActorDisposing
	{
		...
		public void AddTile(CPos cell, TerrainTile tile)
		{
			...
			dirty[cell] = new Sprite(s.Sheet2D, s.Bounds, s.ZRamp, float2.Zero, s.Channel, s.BlendMode);
		}
