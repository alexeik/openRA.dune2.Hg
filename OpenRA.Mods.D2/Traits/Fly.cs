...
namespace OpenRA.Mods.Common.D2.Activities
{
	public class Fly : Activity
	{
		...
		public static void FlyToward(Actor self, Asteroid aircraft, int desiredFacing, WDist desiredAltitude, int turnSpeedOverride = -1)
		{
