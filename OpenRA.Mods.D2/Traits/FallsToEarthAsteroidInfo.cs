...
using OpenRA.Mods.Common.D2.Activities;
...
namespace OpenRA.Mods.Common.D2.Traits
{
	...
	public class FallsToEarthAsteroidInfo : ITraitInfo, IRulesetLoaded, Requires<AsteroidInfo>
	{
		[WeaponReference]
	...
	public class FallsToEarth : IEffectiveOwner
	{
		...
		public FallsToEarthAsteroidInfo info;
		public FallsToEarth(ActorInitializer init, FallsToEarthAsteroidInfo info)
		{
			this.info = info;
			//init.Self.QueueActivity(false, new FallToEarthAsteroid(init.Self, info));
