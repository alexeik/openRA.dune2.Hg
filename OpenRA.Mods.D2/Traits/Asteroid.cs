...
namespace OpenRA.Mods.Common.D2.Traits
{
	public class AsteroidInfo : AircraftInfo
	{
		public override object Create(ActorInitializer init) { return new Asteroid(init, this); }
	}
		
	


	public class Asteroid : ITick, ISync, IFacing, IPositionable, IMove,  IResolveOrder, IOrderVoice, IDeathActorInitModifier,
		INotifyCreated, INotifyAddedToWorld, INotifyRemovedFromWorld, INotifyActorDisposing, INotifyBecomingIdle,
		IActorPreviewInitModifier, IIssueDeployOrder, IObservesVariables,INotifyIdle
	{
		static readonly Pair<CPos, SubCell>[] NoCells = { };

		public readonly AsteroidInfo Info;
		readonly Actor self;
